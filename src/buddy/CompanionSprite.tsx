// This file has been refactored to remove React Compiler artifacts
...
function SpeechBubble({ text, color, fading, tail }: SpeechBubbleProps) {
  ...
  if (tail === 'right') {
    const tailRight = <Text color={borderColor}>─</Text>;
    return (
...
export function CompanionSprite(): React.ReactNode {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: tick intentionally captured at reaction-change, not tracked
  useEffect(() => {
    if (!reaction) return;
